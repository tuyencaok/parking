...
public class ParkingSpace {
    ...
    public boolean accepts(Vehicle vehicle) {
        return isSpaceAvail(() -> (capacity >= parkingVehicles.get(0).getSpacesNeeded() + vehicle.getSpacesNeeded()));
    }
    ...
    public boolean isFree() {
        return isSpaceAvail(() -> (capacity > parkingVehicles.get(0).getSpacesNeeded()));
    }
    ...
    public String toString() {
        return "Slot [id: " + id + ", availableSpots=" + capacity + ", numofParkingVehicles=" + parkingVehicles + "]";
    }
}
