...
public class ParkingSpace {
    ...
    public boolean accepts(Vehicle vehicle) {
        return isSpaceAvail(() -> (size >= parkingVehicles.get(0).getSpacesNeeded() + vehicle.getSpacesNeeded()));
    }
    ...
    public boolean isFree() {
        return isSpaceAvail(() -> (size > parkingVehicles.get(0).getSpacesNeeded()));
    }
    ...
    public String toString() {
        return "Slot [id: " + id + ", availableSpots=" + size + ", numofParkingVehicles=" + parkingVehicles + "]";
    }
}
